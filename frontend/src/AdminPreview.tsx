...
export default function AdminPreview({view}:{view:AdminView}) {
  ...
  return <main className="page"><header className="page-header"><div><p>ระบบจัดการข้อมูลพื้นฐาน</p><h1>{module.title}</h1><p>{module.description}</p></div><span className="prototype-pill">สำหรับผู้ดูแลระบบ</span></header>
